...
Bu repo, mini konveyor hattinin kontrol, izleme, OEE, operator kiosk ve workbook tabanli audit akisini ayni kod tabaninda toplar. Ana aktif gelistirme ekseni `mes_web/` altindaki FastAPI + WebSocket + Excel runtime yapisidir.
...
3. `mes_web` topicleri dinler, dashboard ve kiosk snapshot'larini uretir.
4. Browser dashboard REST + WebSocket ile, kiosk ise ayri route ve ayri bootstrap + WebSocket akisi ile beslenir.
...
- [Tablet Kiosk Durumu](tablet_plan.md)
